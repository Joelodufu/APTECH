...
What does fclose() do?a) Opens a fileb) Closes a file and frees resourcesc) Reads data from a filed) Moves the file pointerAnswer: b) Closes a file and frees resources
